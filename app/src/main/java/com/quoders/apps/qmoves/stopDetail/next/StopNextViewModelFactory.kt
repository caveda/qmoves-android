 ...
 */
class StopNextViewModelFactory(private val stop: Stop, private val line: Line, private val realTimeService: RealTimeService) : ViewModelProvider.Factory {
    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(StopNextViewModel::class.java)) {
            return StopNextViewModel(stop,line, realTimeService) as T
        }
